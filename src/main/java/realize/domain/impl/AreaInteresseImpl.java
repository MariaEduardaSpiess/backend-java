...
import realize.domain.AreaInteresse;

@Entity
@Table(name="areainteresse")
public class AreaInteresseImpl implements AreaInteresse {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AreaInteresseImpl other = (AreaInteresseImpl) obj;
		if (id == null) {
			if (other.id != null)
				return false;
...
//		return voluntario==null?null:voluntario.getId();
//	}
